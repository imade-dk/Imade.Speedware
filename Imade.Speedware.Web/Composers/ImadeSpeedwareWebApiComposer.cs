...
{
    public class ImadeSpeedwareWebApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Imade Speedware Web Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<ImadeSpeedwareWebOperationSecurityFilter>();
            });
        }

        public class ImadeSpeedwareWebOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Imade.Speedware.Web.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
